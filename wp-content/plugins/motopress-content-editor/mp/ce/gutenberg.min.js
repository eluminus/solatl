...
1)})},buildPlaceholder:function(){if(!this.hasPlaceholder){var a=b(b("#mpce-editor-placeholder-html").html());this.$gutenberg.find(".editor-block-list__layout, .block-editor-block-list__layout, .editor-post-text-editor").after(a);this.hasPlaceholder=!0;this.$goToEditorLink=a.find("#mpce-go-to-editor-link");this.$goToEditorButton=a.find("#mpce-go-to-editor-button");this.$goToEditorLink.on("click",function(a){a.preventDefault();wp.data.dispatch("core/editor").savePost();c.redirectAfterSave()})}},bindSwitch:function(){var a=
this;this.$switchModeButton.on("click",function(){var b=wp.data.dispatch("core/editor");a.isCEMode?b.editPost({mpce_gutenberg_mode:!1}):(wp.data.select("core/editor").getEditedPostAttribute("title")||b.editPost({title:MPCEAdmin.noTitleLabel}),b.editPost({mpce_gutenberg_mode:!0}));a.isCEMode=!a.isCEMode;a.toggleStatus();a.isCEMode?a.$goToEditorLink.trigger("click"):b.savePost()})},redirectAfterSave:function(){this.$switchModeButton.prop("disabled",!0);this.$goToEditorLink.prop("disabled",!0);this.$goToEditorButton.addClass("disabled");
