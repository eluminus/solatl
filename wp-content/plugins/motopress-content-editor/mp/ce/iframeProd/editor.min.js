function _typeof(y){"@babel/helpers - typeof";_typeof="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(c){return typeof c}:function(c){return c&&"function"===typeof Symbol&&c.constructor===Symbol&&c!==Symbol.prototype?"symbol":typeof c};return _typeof(y)}
...
function(c){var a,b,d,e;can.Control("CE.LeftBar",{myThis:null},{width:56,visibility:!1,active:!1,templates:null,leftbarWrapper:null,init:function(a,b){d=c("html");e=c("body");CE.LeftBar.myThis=this;this._setTemplates(parent.CE.ObjectTemplatesLibrary.myThis.getWidgets().attr());this.leftBarWrapper=a;this.renderView();parent.CE.ObjectTemplatesLibrary.myThis.getWidgets().bind("change",this.proxy(function(a){this._updateTemplates(a.target.attr())}));this.initStyle();this.setVisible();d.addClass("mpce-page-offset")},
makeObjectsDraggable:function(){c.each(a.find(".motopress-ce-widget-template:not([data-motopress-shortcode])"),function(a,b){var d=c(b).attr("data-id"),d=parent.CE.ObjectTemplatesLibrary.myThis.getWidgetById(d).atts;parent.CE.ShortcodeAtts.setAttsToEl(c(b),d)});c.each(a.find(".motopress-ce-object:not(.ce_draggable_new_block)"),function(a,b){new CE.DraggableNewBlock(c(b))})},renderView:function(){this.leftBarWrapper.html(can.view("leftbar",{library:this._prepareLibrary(),templates:this.templates,test:window.asd}));
a=this.leftBarWrapper.children("#motopress-content-editor-leftbar");b=this.leftBarWrapper.children(".motopress-leftbar-overlap");this.makeObjectsDraggable()},initStyle:function(){var a=parseFloat(d.css("padding-left"))+this.width;this.$style=c('<style type="text/css" id="mpce-left-bar-style" />');this.$style.text("@media (min-width: 769px) { html.mpce-page-offset { padding-left: "+a+"px !important; } }");e.append(this.$style)},_prepareLibrary:function(){var a=[];c.each(parent.CE.WidgetsLibrary.myThis.getLibrary(),
function(b,d){if(d.show){var e=[];c.each(d.objects,function(a,b){if(b.show){var d={closeType:b.closeType,id:b.id,icon:b.icon,group:b.groupId,name:b.name},f={};c.each(b.parameters,function(a){f[a]={}});d.parameters=JSON.stringify(f);var g={};c.each(b.styles,function(a){g[a]={}});d.styles=JSON.stringify(g);e.push(d)}});e.length&&a.push({id:d.id,name:d.name,icon:d.icon,objects:e})}});return a},_setTemplates:function(a){return this.templates=new can.List(a)},_updateTemplates:function(a){this.templates.replace(a);
this.makeObjectsDraggable()},disable:function(){b.show()},enable:function(){b.hide()},setActive:function(){this.active=!0},setInactive:function(){this.active=!1},isActive:function(){return this.active},setVisible:function(){this.visibility=!0},setInvisible:function(){this.visibility=!1},isVisible:function(){return this.visibility},hide:function(c){if(("undefined"===typeof c?0:c)||this.isActive())this.active=!1,this.setInvisible(),a.addClass("mpce-leftbar-hidden"),b.addClass("mpce-leftbar-overlap-hidden"),
d.removeClass("mpce-page-offset"),parent.CE.Iframe.myThis.setSceneWidth(),CE.Resizer.myThis.updateAllHandles(),parent.MP.Editor.triggerEverywhere("LeftBarHide")},show:function(c){if(("undefined"===typeof c?0:c)||this.isActive())this.active=!0,this.setVisible(),a.removeClass("mpce-leftbar-hidden"),b.removeClass("mpce-leftbar-overlap-hidden"),d.addClass("mpce-page-offset"),parent.CE.Iframe.myThis.setSceneWidth(),CE.Resizer.myThis.updateAllHandles(),parent.MP.Editor.triggerEverywhere("LeftBarShow")},
getSpace:function(){return this.isVisible()?this.width:0},getWidth:function(){return this.width},".motopress-leftbar-toggle click":function(b,d){a.hasClass("mpce-leftbar-hidden")?this.show(!0):this.hide(!0)}})}(jQuery),function(c){CE.Grid=can.Control.extend({myThis:null,ENTITIES:{ROW:"row",COLUMN:"column",WIDGET:"widget",PAGE:"page"}},{columnMarginPiece:null,column:null,padding:null,columnCount:parent.CE.Iframe.myThis.gridObj.row.col,columnWidthStatus:null,colWidthByNumber:[],rowEl:c("<div />",{"class":parent.CE.Iframe.myThis.gridObj.row["class"]}),
columnEl:c("<div />",{}),setup:function(a){var b=null;a.append(this.rowEl);for(a=1;a<=this.columnCount;a++)b=this.columnEl.clone().addClass(parent.CE.Iframe.myThis.gridObj.span["class"]+a).appendTo(this.rowEl),this.colWidthByNumber[a]=parseFloat(b.css("width"));this.columnEl.clone().addClass(parent.CE.Iframe.myThis.gridObj.span["class"]+1).appendTo(this.rowEl)},init:function(a){CE.Grid.myThis=this;this.column=a.find("."+parent.CE.Iframe.myThis.gridObj.span.minclass+":last");this.setSize();parent.MP.Editor.onIfr("Resize",
this.proxy("setSize"))},setSize:function(){var a=this.column.width();this.padding=parseFloat(this.column.css("padding-left"));this.columnMarginPiece=parseFloat(this.column.css("margin-left"));this.columnWidthStatus&&(CE.Resizer.myThis.updateSplittableOptions(null,null,null,"init"),CE.Resizer.myThis.updateSplitterHeight());this.columnWidthStatus=a}})}(jQuery),function(c){CE.ShortcodeStyle=can.Construct({generateStateCSS:function(a){var b=[];c.each(a,function(a,c){if(""!==c)switch(a){case "padding-top":case "padding-bottom":case "padding-left":case "padding-right":case "margin-top":case "margin-bottom":case "margin-left":case "margin-right":case "border-top-width":case "border-bottom-width":case "border-left-width":case "border-right-width":case "border-top-left-radius":case "border-top-right-radius":case "border-bottom-left-radius":case "border-bottom-right-radius":isNaN(c)||
