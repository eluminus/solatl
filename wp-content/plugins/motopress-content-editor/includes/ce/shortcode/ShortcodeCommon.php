...
//			wp_enqueue_style('mpce-theme');
    ...
    function mp_posts_slider($attrs, $content, $scTag) {
    ...
    function mp_countdown_timer($attrs, $content, $tag){
    ...
    function mp_wp_archives($attrs, $content, $tag) {
        extract(shortcode_atts(self::addStyleAtts(self::getAtts($tag)), $attrs));
    ...
    function mp_wp_calendar($attrs, $content, $tag) {
        extract(shortcode_atts(self::addStyleAtts(self::getAtts($tag)), $attrs));
    ...
    function mp_wp_categories($attrs, $content, $tag) {
        extract(shortcode_atts(self::addStyleAtts(self::getAtts($tag)), $attrs));
    ...
    function mp_wp_navmenu($attrs, $content, $tag) {
        extract(shortcode_atts(self::addStyleAtts(self::getAtts($tag)), $attrs));
    ...
    function mp_wp_meta($attrs, $content, $tag) {
        extract(shortcode_atts(self::addStyleAtts(self::getAtts($tag)), $attrs));
    ...
    function mp_wp_pages($attrs, $content, $tag) {
        extract(shortcode_atts(self::addStyleAtts(self::getAtts($tag)), $attrs));
    ...
    function mp_wp_posts($attrs, $content, $tag) {
        extract(shortcode_atts(self::addStyleAtts(self::getAtts($tag)), $attrs));
    ...
    function mp_wp_comments($attrs, $content, $tag) {
        extract(shortcode_atts(self::addStyleAtts(self::getAtts($tag)), $attrs));
	...
	function mp_wp_rss($attrs, $content, $tag) {
        extract(shortcode_atts(self::addStyleAtts(self::getAtts($tag)), $attrs));
    ...
    function mp_wp_search($attrs, $content, $tag) {
        extract(shortcode_atts(self::addStyleAtts(self::getAtts($tag)), $attrs));
    ...
    function mp_wp_tagcloud($attrs, $content, $tag) {
        extract(shortcode_atts(self::addStyleAtts(self::getAtts($tag)), $attrs));
	...
	function mp_wp_widgets_area($attrs, $content, $tag) {
        extract(shortcode_atts(self::addStyleAtts(self::getAtts($tag)), $attrs));
    ...
    function mp_gmap($attrs, $content, $tag) {
		...
		if( empty($googleApiKey ) ) {
			if ( current_user_can( 'manage_options' ) ) {
				...
				if ( self::isContentEditor() ) {
					return sprintf(
						__('Set Google Maps API Key in the %1$s plugin settings %2$s.', 'motopress-content-editor'),
						'',
						''
					);
				} else {
    ...
    function mp_embed($attrs, $content, $tag) {
    ...
    function mp_quote($attrs, $content, $tag) {
        extract(shortcode_atts(self::addStyleAtts(self::getAtts($tag)), $attrs));
	...
	function mp_members_content($attrs, $content, $tag) {
		extract(shortcode_atts(self::addStyleAtts(self::getAtts($tag)), $attrs));
    ...
    function mp_social_buttons($attrs, $content, $tag) {
        extract(shortcode_atts(self::addStyleAtts(self::getAtts($tag)), $attrs));
    ...
    function mp_social_profile($attrs, $content, $tag) {
        extract(shortcode_atts(self::addStyleAtts(self::getAtts($tag)), $attrs));
    ...
    function mp_google_chart($attrs, $content, $tag) {
        extract(shortcode_atts(self::addStyleAtts(self::getAtts($tag)), $attrs) );
    ...
    function mp_wp_audio($attrs, $content, $tag) {
        $shortcode = '';
        $mediaIsSet = '';
        $audioTitle = '';
        extract(shortcode_atts(self::addStyleAtts(self::getAtts($tag)), $attrs));
    ...
    function mp_tabs($attrs, $content, $tag) {
        extract(shortcode_atts(self::addStyleAtts(self::getAtts($tag)), $attrs));
    ...
    function mp_tab($attrs, $content, $tag) {
        extract(shortcode_atts(self::addStyleAtts(self::getAtts($tag)), $attrs));
    ...
    function mp_accordion($attrs, $content, $tag) {
        extract(shortcode_atts(self::addStyleAtts(self::getAtts($tag)), $attrs));
    ...
    function mp_accordion_item($attrs, $content, $tag) {
        extract(shortcode_atts(self::addStyleAtts(self::getAtts($tag)), $attrs));
    ...
    public function mp_table($attrs, $content, $tag) {
        extract(shortcode_atts(self::addStyleAtts(self::getAtts($tag)), $attrs));
    ...
    function mp_posts_grid($attrs, $content, $scTag) {
    ...
    function mp_service_box($attrs, $content, $tag){
        extract(shortcode_atts(self::addStyleAtts(self::getAtts($tag)), $attrs));
