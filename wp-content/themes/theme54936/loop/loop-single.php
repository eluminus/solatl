...
<div class="post-author clearfix">
	...
	<p class="post-author_gravatar"><?php if(function_exists('get_avatar')) { echo get_avatar( get_the_author_meta('email'), '82' ); /* This avatar is the user's gravatar (http://gravatar.com) based on their administrative email address */  } ?></p>
	<div class="post-author_desc">
	<?php the_author_meta('description') ?>
		<div class="post-author_link">
			<h3><?php echo theme_locals("view_all"); ?>: <?php the_author_posts_link() ?></h3>
		</div>
	</div>
</div><!--.post-author-->
