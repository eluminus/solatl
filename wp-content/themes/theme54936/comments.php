...
<!-- BEGIN Comments -->	
	...
	<div id="comments" class="comment-holder">
		<h2 class="comments-h"><?php printf( _n( theme_locals("response"), theme_locals("responses"), get_comments_number(), CURRENT_THEME ),
	...
	<h2><?php comment_form_title(theme_locals("leave_a_reply")); ?></h2>
