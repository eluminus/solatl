		...
		<ul class="comments-custom unstyled"><?php
			...
			<li class="comments-custom_li">
				...
				<?php if($display_post_title != 'off') {
					...
					echo '<div class="meta_format">'.$title_format.'<h3 class="comments-custom_h_title"><a href="'.post_permalink($post_ID).'" title="'.get_post($post_ID)->post_title.'">'.get_post($post_ID)->post_title.'</a></h3></div>';
				}?>
				<?php if($display_author_name != 'off') {
					...
					echo'<div class="meta_format">'.$title_author_name.'<h3 class="comments-custom_h_author">'.$comment->comment_author.'</h3></div>';
				}?>
				<?php
				if($display_date != 'off') {
					$title_date = "";
					...
					echo '<div class="meta_format">'.$title_date.'<h3><time datetime="'.date('Y-m-d\TH:i:s', strtotime($comment_date.$comment_time)).'">'.$comment_date.' '.$comment_time.'</time></h3></div>';
				}?>
			<div class="clear"></div>
